...
public class SplashState extends BasicGameState {
	...
	private static final int DELAY = 3000; // 3s default //0  - for debugging TODO
	...
	public void init(GameContainer container, StateBasedGame game)
		...
		try {
			...
			game.addState(Game.MENU);
			game.addState(Game.SETTINGS);
			game.addState(Game.PLAY);
			game.addState(Game.CONTROL);
